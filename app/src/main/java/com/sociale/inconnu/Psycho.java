...
public class Psycho extends AppCompatActivity implements View.OnClickListener {
    private TextView T1;
    private TextView T2;
    private TextView T3;
    private TextView T4;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case  R.id.perso1 :
                ...
                P1.setClass(Psycho.this, Communication.class);
                startActivity(P1);
            case R.id.perso2 :
                Intent P2 = new Intent();
                P2.setClass(Psycho.this,Communication.class);
                startActivity(P2);
            case R.id.perso3 :
                Intent P3 = new Intent();
                P3.setClass(Psycho.this, Communication.class);
                startActivity(P3);
            case R.id.perso4 :
                Intent P4 = new Intent();
                P4.setClass(Psycho.this, Communication.class);
                startActivity(P4);
            case R.id.perso5 :
                Intent P5 = new Intent();
                P5.setClass(Psycho.this, Communication.class);
                startActivity(P5);
            case R.id.perso6 :
                Intent P6 = new Intent();
                P6.setClass(Psycho.this, Communication.class);
                startActivity(P6);
            case R.id.perso7 :
                Intent P7 = new Intent();
                P7.setClass(Psycho.this, Communication.class);
                startActivity(P7);
            case R.id.perso8 :
                Intent P8 = new Intent();
                P8.setClass(Psycho.this, Communication.class);
                startActivity(P8);
            case R.id.perso9 :
                Intent P9 = new Intent();
                P9.setClass(Psycho.this, Communication.class);
                startActivity(P9);
            case R.id.perso10 :
                Intent P10 = new Intent();
                P10.setClass(Psycho.this, Communication.class);
                startActivity(P10);
            case R.id.perso11 :
                Intent P11 = new Intent();
                P11.setClass(Psycho.this, Communication.class);
                startActivity(P11);
            case R.id.perso12 :
                Intent P12 = new Intent();
                P12.setClass(Psycho.this, Communication.class);
                startActivity(P12);
            case R.id.perso13 :
                Intent P13 = new Intent();
                P13.setClass(Psycho.this, Communication.class);
                startActivity(P13);
            case R.id.perso14 :
                Intent P14 = new Intent();
                P14.setClass(Psycho.this, Communication.class);
                startActivity(P14);
            case R.id.perso15 :
                Intent P15 = new Intent();
                P15.setClass(Psycho.this, Communication.class);
                startActivity(P15);
            case R.id.perso16 :
                Intent P16 = new Intent();
                P16.setClass(Psycho.this, Communication.class);
                startActivity(P16);
